...
const Navbar = () => {
  ...
  <div className="navbar-start">
    ...
    <a className="btn btn-ghost normal-case text-xl text-secondary">BiCycle PaRts StoRe</a>
  </div>
  ...
  <div className='navbar-end'><label tabIndex="1" htmlFor="my-drawer-2" className="btn btn-ghost text-white lg:hidden">
